def juntar(*listas):
    list_prod = []
    for lista in listas:
        for prod, qnt in lista:
            list_prod.append(prod)
    list_prod = set(list_prod) #Removendo os produtos duplicados
    list_prod = list(list_prod)
    return list_prod
...
list_cop = juntar(estoque_fim_jan, estoque_fim_fev, estoque_fim_mar, estoque_fim_abr)
print(list_cop)
print(len(list_cop))
